                    ...
                    <div class="form-content contact-form-action">
                        <form method="post" class="row">
                            <div class="col-lg-6 responsive-column">
                                <div class="input-box">
                                    <label class="label-text">Listing Name</label>
                        ...
                        <form method="post" class="row">
                            <div class="col-lg-6">
                                <div class="custom-checkbox">
                                    <input type="checkbox" id="is_washingmachine"  name="is_washingmachine" value="{{$room->anemities->is_washingmachine}}"  {{  ($room->anemities->is_washingmachine== 1 ? 'checked' : '') }}>
                                    <label for="is_washingmachine">Washing Machine</label>
                                </div>
                                <div class="custom-checkbox">
                                    <input type="checkbox" id="is_tv" name="is_tv" value="{{$room->anemities->is_tv}}"  {{  ($room->anemities->is_tv == 1 ? 'checked' : '') }}>
                                    <label for="is_tv">TV</label>
                                </div>
                                <div class="custom-checkbox">
                                    <input type="checkbox" id="is_air" name="is_air" value="{{$room->anemities->is_air}}"  {{  ($room->anemities->is_air == 1 ? 'checked' : '') }}>
                                    <label for="is_air">Air condition</label>
                                </div>
                                <div class="custom-checkbox">
                                    <input type="checkbox" id="is_coffeemaker" value="{{$room->anemities->is_coffeemaker}}"  {{  ($room->anemities->is_coffeemaker == 1 ? 'checked' : '') }}>
                                    <label for="is_coffeemaker">Coffee Maker</label>
                                </div>
                                <div class="custom-checkbox">
                                    <input type="checkbox" id="is_dryer" name="is_dryer" value="{{$room->anemities->is_dryer}}"  {{  ($room->anemities->is_dryer == 1 ? 'checked' : '') }}>
                            ...
                            <div class="col-lg-6">
                                <div class="custom-checkbox">
                                    <input type="checkbox" id="is_iron" name="is_iron" value="{{$room->anemities->is_iron}}"  {{  ($room->anemities->is_iron == 1 ? 'checked' : '') }}>
                                    <label for="BeverageSelection">Iron</label>
                                </div>
                                <div class="custom-checkbox">
                                    <input type="checkbox" id="is_firstaidkit" name="is_firstaidkit" value="{{$room->anemities->is_firstaidkit}}"  {{  ($room->anemities->is_firstaidkit == 1 ? 'checked' : '') }}>
                                    <label for="is_firstaidkit">First-Aid Kit</label>
                                </div>
                                <div class="custom-checkbox">
                                    <input type="checkbox" id="is_heating" name="is_heating" value="{{$room->anemities->is_heating}}"  {{  ($room->anemities->is_heating == 1 ? 'checked' : '') }}>
                                    <label for="is_heating">Heating</label>
                                </div>
                                <div class="custom-checkbox">
                                    <input type="checkbox" id="is_wifi" name="is_wifi" value="{{$room->anemities->is_wifi}}"  {{  ($room->anemities->is_wifi == 1 ? 'checked' : '') }}>
