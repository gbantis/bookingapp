...
<!-- ================================
    START FORM AREA
================================= -->
<form  action="/{{$room->id}}/update"  method="POST" enctype="multipart/form-data">
    @csrf
    @method('PATCH')
                            ...
                            <div class="row">
                                <div class="col-lg-6 responsive-column">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="title" placeholder="Business name" value="{{ $room->title }}">
                                        </div>
                                    </div>
                                </div><!-- end col-lg-6 -->
                                <div class="col-lg-6 responsive-column">
                                ...
                                <div class="col-lg-6 responsive-column">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text"  placeholder="example: New York">
                                        </div>
                                    </div>
                                </div><!-- end col-lg-6 -->
                                <div class="col-lg-6 responsive-column d-flex align-items-center">
                                    <div class="input-box">
                                        <div class="form-group custom-checkbox pt-4">
                                            <input type="checkbox" id="yourCityIsNotListed">
                                ...
                                <div class="col-lg-12">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            <span class="la la-map-marker form-icon"></span>
                                            <input class="form-control" type="text"  placeholder="Suite number, intersection, plaza, square">
                                        </div>
                                    </div>
                                </div><!-- end col-lg-12 -->
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder="Total number of rooms & suites">
                                        </div>
                                    </div>
                                </div><!-- end col-lg-12 -->
                                <div class="col-lg-6">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group d-flex align-items-center">
                                            <input class="form-control pl-3" type="text"  placeholder="Per Night" value="${{ $room->price }}">
                                ...
                                <div class="col-lg-12">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            <span class="la la-pencil form-icon"></span>
                                            <textarea class="message-control form-control" name="body"  placeholder="In English only, no HTML, no web or email address, no ALL CAPS  ">{{ $room->body }}</textarea>
                                        </div>
                                    </div>
                                </div><!-- end col-lg-12 -->
                                <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="is_washingmachine"  name="is_washingmachine" value="1"  {{  ($room->anemities->is_washingmachine== 1 ? 'checked' : '') }}>
                                            <label for="is_washingmachine">Washing Mache</label>
                                        </div>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="is_tv" name="is_tv" value="1"  {{  ($room->anemities->is_tv == 1 ? 'checked' : '') }}>
                                            <label for="is_tv">TV</label>
                                        </div>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="is_air" name="is_air" value="1"  {{  ($room->anemities->is_air == 1 ? 'checked' : '') }}>
                                            <label for="is_air">Air condition</label>
                                        </div>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="is_coffeemaker" name="is_coffeemaker" value="1"  {{  ($room->anemities->is_coffeemaker == 1 ? 'checked' : '') }}>
                                            <label for="is_coffeemaker">Coffee Maker</label>
                                        </div>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="is_dryer" name="is_dryer" value="1"  {{  ($room->anemities->is_dryer == 1 ? 'checked' : '') }}>
                                            <label for="is_dryer">Dryer</label>
                                        </div>
                                    </div><!-- end col-lg-6 -->
                                    <div class="col-lg-6">
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="is_iron" name="is_iron" value="1"  {{  ($room->anemities->is_iron == 1 ? 'checked' : '') }}>
                                            <label for="is_iron">Iron</label>
                                        </div>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="is_firstaidkit" name="is_firstaidkit" value="1"  {{  ($room->anemities->is_firstaidkit == 1 ? 'checked' : '') }}>
                                            <label for="is_firstaidkit">First-Aid Kit</label>
                                        </div>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="is_heating" name="is_heating" value="1"  {{  ($room->anemities->is_heating == 1 ? 'checked' : '') }}>
                                            <label for="is_heating">Heating</label>
                                        </div>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="is_wifi" name="is_wifi" value="1"  {{  ($room->anemities->is_wifi == 1 ? 'checked' : '') }}>
                                            <label for="is_wifi">Wifi</label>
                                        </div>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="PetsAllowed">
                                            <label for="PetsAllowed">Something Else..</label>
                                        </div><!-- end col-lg-6 -->
                                    </div>
                                </div><!-- end form-content -->
                            </div><!-- end form-box -->
                                ...
                                <div class="form-content contact-form-action">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="file-upload-wrap file-upload-wrap-2">
                                            <input type="file" name="cover_image" value="{{ $room->cover_image }}" class="multi file-upload-input with-preview" >
