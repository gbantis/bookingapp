!function(e) {
    ...
    t.on("load", function() {
        var l = e(document)
            ...
            , Y = e('input[name="checkin"]')
            , J = e('input[name="checkout"]')
            , $ = e(".select-contain-select")
            , M = e(".counter")
            , P = e(".full-width-slider");
        if (n.delay("500").fadeOut(2e3),
            ...
            l.on("click", ".main-menu-content .drop-menu-toggler", function() {
                return e(this).parent().parent().children(".dropdown-menu-item").toggle(),
                    !1
            }),
            ...
            l.on("click", ".main-menu-content .dropdown-menu-item .sub-menu-toggler", function() {
                return e(this).parent().parent().children(".sub-menu").toggle(),
                    !1
            }),
            ...
            t.on("resize", function() {
                t.width() > 991 ? (e(".main-menu-content").show(),
                    e(".dropdown-menu-item").show(),
                    e(".sub-menu").show(),
                    e(".header-top-bar").show()) : (e(".main-menu-content").hide(),
        ...
        t.on("scroll", function() {
            t.scrollTop() >= z ? (document.body.style.paddingTop = o.offsetHeight + "px",
                document.body.classList.add("fixed-nav")) : (document.body.style.paddingTop = "0px",
                document.body.classList.remove("fixed-nav")),
                t.scrollTop() > 500 ? e(s).addClass("active") : e(s).removeClass("active"),
                e(".page-scroll").each(function() {
                    e(this).offset().top - e(window).scrollTop() < 20 && (r.removeClass("active"),
                        e("#single-content-nav").find('[data-scroll="' + e(this).attr("id") + '"]').addClass("active"))
                })
        }),
        ...
        e(J).length && e(J).daterangepicker({
            singleDatePicker: !0,
            opens: "right",
            locale: {
                format: "DD/MM/YYYY"
