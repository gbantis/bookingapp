...
namespace Clockwork\Support\Laravel {
        class Facade
        {
             ...
             *
             * @param mixed      $name
             * @param null|mixed $exitCode
             * @param mixed      $arguments
             * @param mixed      $options
             * @param mixed      $argumentsDefaults
             * @param mixed      $optionsDefaults
             ...
             * @param mixed      $name
             * @param mixed      $status
             * @param null|mixed $statusMessage
             * @param mixed      $asserts
             */
             ...
             * @static
             *
             * @param null|mixed $shouldCollect
             */
